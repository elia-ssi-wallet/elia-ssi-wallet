...
///
/// When open, the [CupertinoDropDownMenu] shows the child, or the widget returned
...
class CupertinoDropDownMenu extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [CupertinoDropDownMenu].
  ///
  /// When the [CupertinoDropDownMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [CupertinoDropDownMenu] is "closed", this widget acts like a
  ...
  @override
  State<CupertinoDropDownMenu> createState() => _CupertinoDropDownMenuState();
}

class _CupertinoDropDownMenuState extends State<CupertinoDropDownMenu> with TickerProviderStateMixin {
  ...
  void _onTap() {
    if (_openController.isAnimating && _openController.value < 0.1) {
  ...
  void _onTapDown(TapDownDetails details) {
    ...
    // There is a known inconsistency with native here, due to
